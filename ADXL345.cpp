 ...
 * Author: caca
 * 
 * Created on August 28, 2013, 7:30 PM
 */
...
void ADXL345::initialize() {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, 0);
    setAutoSleepEnabled(true);
    setMeasureEnabled(true);
}

uint8_t ADXL345::getDeviceID() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DEVID);
}

uint8_t ADXL345::getTapThreshold() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_THRESH_TAP);
}

void ADXL345::setTapThreshold(uint8_t threshold) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_THRESH_TAP, threshold);
}

void ADXL345::setOffset(int8_t x, int8_t y, int8_t z) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_OFSX, x);
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_OFSY, y);
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_OFSZ, z);
}

int8_t ADXL345::getOffsetX() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_OFSX);
}
...
int8_t ADXL345::getOffsetY() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_OFSY);
}
...
int8_t ADXL345::getOffsetZ() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_OFSZ);
}
...
uint8_t ADXL345::getTapDuration() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DUR);
}

void ADXL345::setTapDuration(uint8_t duration) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DUR, duration);
}

uint8_t ADXL345::getDoubleTapLatency() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_LATENT);
}

void ADXL345::setDoubleTapLatency(uint8_t latency) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_LATENT, latency);
}

uint8_t ADXL345::getDoubleTapWindow() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_WINDOW);
}

void ADXL345::setDoubleTapWindow(uint8_t window) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_WINDOW, window);
}

uint8_t ADXL345::getActivityThreshold() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_THRESH_ACT);
}

void ADXL345::setActivityThreshold(uint8_t threshold) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_THRESH_ACT, threshold);
}

uint8_t ADXL345::getInactivityThreshold() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_THRESH_INACT);
}

void ADXL345::setInactivityThreshold(uint8_t threshold) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_THRESH_INACT, threshold);
}

uint8_t ADXL345::getInactivityTime() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TIME_INACT);
}

void ADXL345::setInactivityTime(uint8_t time) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TIME_INACT, time);
}

bool ADXL345::getActivityAC() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_AC_BIT);
}

void ADXL345::setActivityAC(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_ACT_AC_BIT);
}

bool ADXL345::getActivityXEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_X_BIT);
}

void ADXL345::setActivityXEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_ACT_X_BIT);
}

bool ADXL345::getActivityYEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_Y_BIT);
}

void ADXL345::setActivityYEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_ACT_Y_BIT);

}

bool ADXL345::getActivityZEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_ACT_Z_BIT);
}

void ADXL345::setActivityZEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_ACT_Z_BIT);
}

bool ADXL345::getInactivityAC() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_AC_BIT);
}
...
void ADXL345::setInactivityAC(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_INACT_AC_BIT);
}
...
bool ADXL345::getInactivityXEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_X_BIT);
}
...
void ADXL345::setInactivityXEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_INACT_X_BIT);
}
...
bool ADXL345::getInactivityYEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_Y_BIT);
}
...
void ADXL345::setInactivityYEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_INACT_Y_BIT);
}
...
bool ADXL345::getInactivityZEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, ADXL345_AIC_INACT_Z_BIT);
}
...
void ADXL345::setInactivityZEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_INACT_CTL, enabled, ADXL345_AIC_INACT_Z_BIT);
}
...
uint8_t ADXL345::getFreefallThreshold() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_AIC_INACT_Z_BIT);
}
...
void ADXL345::setFreefallThreshold(uint8_t threshold) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_THRESH_FF, threshold);
}
...
uint8_t ADXL345::getFreefallTime() {
    return i2c.readByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TIME_FF);
}
...
void ADXL345::setFreefallTime(uint8_t time) {
    i2c.writeByteNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TIME_FF, time);
}
...
bool ADXL345::getTapAxisSuppress() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_SUP_BIT);
}
...
void ADXL345::setTapAxisSuppress(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, enabled, ADXL345_TAPAXIS_SUP_BIT);
}
...
bool ADXL345::getTapAxisXEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_X_BIT);
}
...
void ADXL345::setTapAxisXEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, enabled, ADXL345_TAPAXIS_X_BIT);
}
...
bool ADXL345::getTapAxisYEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_Y_BIT);
}
...
void ADXL345::setTapAxisYEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, enabled, ADXL345_TAPAXIS_Y_BIT);
}
...
bool ADXL345::getTapAxisZEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, ADXL345_TAPAXIS_Z_BIT);
}
...
void ADXL345::setTapAxisZEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_TAP_AXES, enabled, ADXL345_TAPAXIS_Z_BIT);
}
...
bool ADXL345::getActivitySourceX() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ACTX_BIT);
}
...
bool ADXL345::getActivitySourceY() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ACTY_BIT);
}
...
bool ADXL345::getActivitySourceZ() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ACTZ_BIT);
}
...
bool ADXL345::getAsleep() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_ASLEEP_BIT);
}
...
bool ADXL345::getTapSourceX() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_TAPX_BIT);
}
...
bool ADXL345::getTapSourceY() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_TAPY_BIT);
}
...
bool ADXL345::getTapSourceZ() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_ACT_TAP_STATUS, ADXL345_TAPSTAT_TAPZ_BIT);
}
...
bool ADXL345::getLowPowerEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_BW_RATE, ADXL345_BW_LOWPOWER_BIT);
}
...
void ADXL345::setLowPowerEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_BW_RATE, enabled, ADXL345_BW_LOWPOWER_BIT);
}
...
uint8_t ADXL345::getRate() {
    return i2c.readBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_BW_RATE, ADXL345_BW_RATE_LENGTH, ADXL345_BW_LOWPOWER_BIT);
}
...
void ADXL345::setRate(uint8_t rate) {
    i2c.writeBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_BW_RATE, rate, ADXL345_BW_RATE_LENGTH, ADXL345_BW_LOWPOWER_BIT);
}
...
bool ADXL345::getLinkEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, ADXL345_PCTL_LINK_BIT);
}
...
void ADXL345::setLinkEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, enabled, ADXL345_PCTL_LINK_BIT);
...
bool ADXL345::getAutoSleepEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, ADXL345_PCTL_AUTOSLEEP_BIT);
}
...
void ADXL345::setAutoSleepEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, enabled, ADXL345_PCTL_AUTOSLEEP_BIT);
}
...
bool ADXL345::getMeasureEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, ADXL345_PCTL_MEASURE_BIT);
}
...
void ADXL345::setMeasureEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, enabled, ADXL345_PCTL_MEASURE_BIT);
}
...
bool ADXL345::getSleepEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, ADXL345_PCTL_SLEEP_BIT);
}
...
void ADXL345::setSleepEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, enabled, ADXL345_PCTL_SLEEP_BIT);
...
uint8_t ADXL345::getWakeupFrequency() {
    return i2c.readBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, ADXL345_PCTL_WAKEUP_LENGTH, ADXL345_PCTL_WAKEUP_BIT);
}
...
void ADXL345::setWakeupFrequency(uint8_t frequency) {
    i2c.writeBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_POWER_CTL, frequency, ADXL345_PCTL_WAKEUP_LENGTH, ADXL345_PCTL_WAKEUP_BIT);
}
...
bool ADXL345::getIntDataReadyEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_DATA_READY_BIT);
}
...
void ADXL345::setIntDataReadyEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_DATA_READY_BIT);
}
...
bool ADXL345::getIntSingleTapEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_SINGLE_TAP_BIT);
}
...
void ADXL345::setIntSingleTapEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_SINGLE_TAP_BIT);
}
...
bool ADXL345::getIntDoubleTapEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
void ADXL345::setIntDoubleTapEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
bool ADXL345::getIntActivityEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_ACTIVITY_BIT);
}
...
void ADXL345::setIntActivityEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_ACTIVITY_BIT);
}
...
bool ADXL345::getIntInactivityEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_INACTIVITY_BIT);
}
...
void ADXL345::setIntInactivityEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_INACTIVITY_BIT);
}
...
bool ADXL345::getIntFreefallEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_FREE_FALL_BIT);
}
...
void ADXL345::setIntFreefallEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_FREE_FALL_BIT);
}
...
bool ADXL345::getIntWatermarkEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_WATERMARK_BIT);
}
...
void ADXL345::setIntWatermarkEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_WATERMARK_BIT);
}
...
bool ADXL345::getIntOverrunEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, ADXL345_INT_OVERRUN_BIT);
}
...
void ADXL345::setIntOverrunEnabled(bool enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_ENABLE, enabled, ADXL345_INT_OVERRUN_BIT);
}
...
uint8_t ADXL345::getIntDataReadyPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_DATA_READY_BIT);
}
...
void ADXL345::setIntDataReadyPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_DATA_READY_BIT);
}
...
uint8_t ADXL345::getIntSingleTapPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_SINGLE_TAP_BIT);
}
...
void ADXL345::setIntSingleTapPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_SINGLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntDoubleTapPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
void ADXL345::setIntDoubleTapPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntActivityPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_ACTIVITY_BIT);
}
...
void ADXL345::setIntActivityPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_ACTIVITY_BIT);
}
...
uint8_t ADXL345::getIntInactivityPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_INACTIVITY_BIT);
}
...
void ADXL345::setIntInactivityPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_INACTIVITY_BIT);
...
uint8_t ADXL345::getIntFreefallPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_FREE_FALL_BIT);
}
...
void ADXL345::setIntFreefallPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_FREE_FALL_BIT);
}
...
uint8_t ADXL345::getIntWatermarkPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_WATERMARK_BIT);
}
...
void ADXL345::setIntWatermarkPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_WATERMARK_BIT);
}
...
uint8_t ADXL345::getIntOverrunPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, ADXL345_INT_OVERRUN_BIT);
}
...
void ADXL345::setIntOverrunPin(uint8_t pin) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_MAP, pin, ADXL345_INT_OVERRUN_BIT);
}
...
uint8_t ADXL345::getIntDataReadySource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_DATA_READY_BIT);
}
...
uint8_t ADXL345::getIntSingleTapSource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_SINGLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntDoubleTapSource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_DOUBLE_TAP_BIT);
}
...
uint8_t ADXL345::getIntActivitySource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_ACTIVITY_BIT);
}
...
uint8_t ADXL345::getIntInactivitySource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_INACTIVITY_BIT);
}
...
uint8_t ADXL345::getIntFreefallSource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_FREE_FALL_BIT);
}
...
uint8_t ADXL345::getIntWatermarkSource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_WATERMARK_BIT);
}
...
uint8_t ADXL345::getIntOverrunSource() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_INT_SOURCE, ADXL345_INT_OVERRUN_BIT);
}
...
uint8_t ADXL345::getSelfTestEnabled() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_SELFTEST_BIT);
}
...
void ADXL345::setSelfTestEnabled(uint8_t enabled) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, enabled, ADXL345_FORMAT_SELFTEST_BIT);
}
...
uint8_t ADXL345::getSPIMode() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_SPIMODE_BIT);
}
...
void ADXL345::setSPIMode(uint8_t mode) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, mode, ADXL345_FORMAT_SPIMODE_BIT);
}
...
uint8_t ADXL345::getInterruptMode() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_INTMODE_BIT);
}
...
void ADXL345::setInterruptMode(uint8_t mode) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, mode, ADXL345_FORMAT_INTMODE_BIT);
}
...
uint8_t ADXL345::getFullResolution() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_FULL_RES_BIT);
}
...
void ADXL345::setFullResolution(uint8_t resolution) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, resolution, ADXL345_FORMAT_FULL_RES_BIT);
}
...
uint8_t ADXL345::getDataJustification() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_JUSTIFY_BIT);
}
...
void ADXL345::setDataJustification(uint8_t justification) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, justification, ADXL345_FORMAT_JUSTIFY_BIT);
}
...
uint8_t ADXL345::getRange() {
    return i2c.readBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, ADXL345_FORMAT_RANGE_LENGTH, ADXL345_FORMAT_RANGE_BIT);
}
...
void ADXL345::setRange(uint8_t range) {
    i2c.writeBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATA_FORMAT, range, ADXL345_FORMAT_RANGE_LENGTH, ADXL345_FORMAT_RANGE_BIT);
}
...
void ADXL345::getAcceleration(int16_t* x, int16_t* y, int16_t* z) {
    *x = i2c.readWordNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATAX1, ADXL345_RA_DATAX0);
    *y = i2c.readWordNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATAY1, ADXL345_RA_DATAY0);
    *z = i2c.readWordNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATAZ1, ADXL345_RA_DATAZ0);
}
...
int16_t ADXL345::getAccelerationX() {
    return i2c.readWordNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATAX1, ADXL345_RA_DATAX0);
}
...
int16_t ADXL345::getAccelerationY() {
    return i2c.readWordNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATAY1, ADXL345_RA_DATAY0);
}
...
int16_t ADXL345::getAccelerationZ() {
    return i2c.readWordNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_DATAZ1, ADXL345_RA_DATAZ0);
}
...
uint8_t ADXL345::getFIFOMode() {
    return i2c.readBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_CTL, ADXL345_FIFO_MODE_LENGTH, ADXL345_FIFO_MODE_BIT);
}
...
void ADXL345::setFIFOMode(uint8_t mode) {
    i2c.writeBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_CTL, mode, ADXL345_FIFO_MODE_LENGTH, ADXL345_FIFO_MODE_BIT);
}
...
uint8_t ADXL345::getFIFOTriggerInterruptPin() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_CTL, ADXL345_FIFO_TRIGGER_BIT);
}
...
void ADXL345::setFIFOTriggerInterruptPin(uint8_t interrupt) {
    i2c.writeBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_CTL, interrupt, ADXL345_FIFO_TRIGGER_BIT);
}
...
uint8_t ADXL345::getFIFOSamples() {
    return i2c.readBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_CTL, ADXL345_FIFO_SAMPLES_LENGTH, ADXL345_FIFO_SAMPLES_BIT);
}
...
void ADXL345::setFIFOSamples(uint8_t size) {
    i2c.writeBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_CTL, size, ADXL345_FIFO_SAMPLES_LENGTH, ADXL345_FIFO_SAMPLES_BIT);
}
...
bool ADXL345::getFIFOTriggerOccurred() {
    return i2c.readBitNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_STATUS, ADXL345_FIFOSTAT_TRIGGER_BIT);
}
...
uint8_t ADXL345::getFIFOLength() {
    return i2c.readBitsNoExit(ADXL345_DEFAULT_ADDRESS, ADXL345_RA_FIFO_STATUS, ADXL345_FIFOSTAT_LENGTH_BIT, ADXL345_FIFOSTAT_BIT_START);
}