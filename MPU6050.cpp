...
void MPU6050::setFIFO_Enable(uint8_t value) {
    i2c.writeBitNoExit(USER_CTRL, value, 6);
}

uint8_t MPU6050::getFIFO_Enable() {
    return i2c.readBitNoExit(USER_CTRL, 6);
}
...
void MPU6050::setFIFO_Reset(uint8_t value) {
    i2c.writeBitNoExit(USER_CTRL, value, 2);
}

uint8_t MPU6050::getFIFO_Reset() {
    return i2c.readBitNoExit(USER_CTRL, 2);
}
