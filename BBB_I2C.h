...
public:
    ...
    void writeBitsNoExit(char DEV_ADD, char DATA_REGADD, char value, int length, int startBit, int bus);
    ...
    uint8_t readBitsNoExit(char DEV_ADD, char DATA_REGADD, uint8_t length, uint8_t startBit, int bus);
    uint8_t readByte(char DEV_ADD, char DATA_REGADD, int bus);
    uint8_t readByteNoExit(char DEV_ADD, char DATA_REGADD, int bus);
